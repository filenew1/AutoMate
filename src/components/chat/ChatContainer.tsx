...
export const ChatContainer: React.FC<ChatContainerProps> = ({ agentId }) => {
  ...
  const getChatAreaClasses = () => {
    let baseClasses = 'flex-1 overflow-y-auto p-4 relative'
    return baseClasses
  }
    ...
    <div className={getContainerClasses()}>
      ...
      {showScrollButton && (
        <button
          ...
          className="fixed bottom-36 left-1/2 -translate-x-1/2 w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50 cursor-pointer flex items-center justify-center"
          title="滚动到底部"
        >
